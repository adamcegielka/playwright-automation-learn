...
// npm test tests/e2e_JakTestowacPl/lesson_02
// npm test -- tests/e2e_JakTestowacPl/lesson_02 --project=chromium
// npm test -- tests/e2e_JakTestowacPl/lesson_02/login.spec.ts --project=chromium
