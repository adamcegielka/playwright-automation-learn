...
test.describe('Desktop testing', () => {
  ...
  test('successful mobile phone top-up', async () => {
    // Arrange
...
// npm test -- tests/e2e_JakTestowacPl/lesson_16/desktop.spec.ts --project=chromium
// npm test -- tests/e2e_JakTestowacPl/lesson_16/desktop.spec.ts --project=chromium --headed
