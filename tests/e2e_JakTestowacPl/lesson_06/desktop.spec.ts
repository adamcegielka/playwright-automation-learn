...
// npm test -- tests/e2e_JakTestowacPl/lesson_06/desktop.spec.ts --project=chromium
// npm test -- tests/e2e_JakTestowacPl/lesson_06/desktop.spec.ts --project=chromium --headed
