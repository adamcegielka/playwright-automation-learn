...
// npm test -- tests/e2e_JakTestowacPl/lesson_15/payment.spec.ts --project=chromium
// npm test -- tests/e2e_JakTestowacPl/lesson_15/payment.spec.ts --project=chromium --headed
