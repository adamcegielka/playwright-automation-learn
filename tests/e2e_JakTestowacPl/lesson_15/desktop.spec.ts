...
// npm test -- tests/e2e_JakTestowacPl/lesson_15/desktop.spec.ts --project=chromium
// npm test -- tests/e2e_JakTestowacPl/lesson_15/desktop.spec.ts --project=chromium --headed
